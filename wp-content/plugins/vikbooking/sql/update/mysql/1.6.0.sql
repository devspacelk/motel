...
ALTER TABLE `#__vikbooking_customers` ADD `state` varchar(64) DEFAULT NULL AFTER `zip`;

ALTER TABLE `#__vikbooking_gpayments` ADD `idrooms` varchar(1024) DEFAULT NULL;

ALTER TABLE `#__vikbooking_coupons` ADD `maxtotord` decimal(12,2) DEFAULT NULL;
